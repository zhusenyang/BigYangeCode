...
var sogouTall = '<form action="http://agent.sogou.com/sendMsgQueenCtrl.php" method="post" name="sendQueenFBean" id="sogouMessage" target=sogouMsgFrame>'
		+ '<div class="sogoulyb skin1" style="z-index:1000;position: absolute;text-align:left;left:0" id="sogoubox">'
	    + '<h2 id="sogouh2">'
	    + '<img src="http://image.p4p.sogou.com/bizimg/msg_sogou/images/skin2/collapse2.gif" alt="��С��" width="15" height="14" onclick="javascript:sogouChSize();" id="sogouImg">'
	    + '���԰�'
	    + '</h2>'
	    ...
	    + '<input  type="text" value="�������ֻ�����" size="20" name="sogouVisitorPhone" onclick="javascript:sogouClearDefault(2);" onblur="javascript:sogouReDefault(2);">'
	    + '</div>'
	    + '<div class="lybemail" style="display:block">'
	    + '<input type="text" value="����������ʼ�" size="20" name="sogouVisitorEmail" onclick="javascript:sogouClearDefault(3);" onblur="javascript:sogouReDefault(3);">'
	    + '</div>'
	    + '<div class="lybadd" style="display:block">'
	    + '<input  type="text" value="������ϵ�ˣ���xx����/Ůʿ" size="20" name="sogouVisitorAddress" onclick="javascript:sogouClearDefault(4);" onblur="javascript:sogouReDefault(4);">'
	    + '</div>'
	    + '<p class="donot">���𷢱�Ƿ����ۡ�</p>'
	    + '<div class="lybfoot">'
	    + '<input  type="button" class="lybtn" value="�� ��" onclick="javascript:sogouValidMessage();" >'
	    + '</div>'
	    + '<input type=hidden name="sogouAccountId" value="19992920">'
	    + '<input type="hidden" name="sogouSecretKey" value="lozMhVt+5K5V6cGCTaYYHw==" />'
...
var msgDefaultValue = "���ã�����������ǵĲ�Ʒ��������Ȥ�������˴����ԣ�";
var contDefaultValue = "������������ϵ��ʽ�����ǻᾡ��������ϵ��";




SogouDemoDiv = function(){};
SogouDemoDiv.oDiv = null;
SogouDemoDiv.iLap = 2;
SogouDemoDiv.register = function(sDivId){
	try{
		SogouDemoDiv.oDiv = document.getElementById(sDivId);
		SogouDemoDiv.oDiv.position = "absolute";
		SogouDemoDiv.oDiv.style.display = "none";
	}catch(e){
		SogouDemoDiv.oDiv = null;
	}
};
...
SogouDemoDiv.close = function(){
	if(null === SogouDemoDiv.oDiv){return;}
	SogouDemoDiv.oDiv.style.display = "none";	
	SogouDemoDiv.removeEvt();
};
SogouDemoDiv.addEvt = function(){
	window.onscroll=SogouDemoDiv.setPosition;
	window.onresize=SogouDemoDiv.setPosition;	
};
SogouDemoDiv.removeEvt = function(){
...
function sogouChSize(){
	...
	if(sogouSizeType == 0){
			sogouSizeType = 1;
			imgUrl = "http://image.p4p.sogou.com/bizimg/msg_sogou/images/skin2/max1.gif";
			imgText = "���";
			...
			sogouSizeType = 0;
			imgUrl = "http://image.p4p.sogou.com/bizimg/msg_sogou/images/skin2/collapse1.gif";
			imgText = "��С��";
...
function sogouValidMessage()
{
		...
		if(false){
				var phoneValue = document.getElementsByName("sogouVisitorPhone")[0].value;
					if(sogouTrim(phoneValue) == ""){
						alert("�ֻ����벻��Ϊ��");
						return;
					}else if(sogouTrim(phoneValue) == "�������ֻ�����"){
							alert("����û����д�ֻ����룡");
							return;
		...
		if(false){
			var emailValue = document.getElementsByName("sogouVisitorEmail")[0].value;
					if(sogouTrim(emailValue) == ""){
						alert("�����ʼ�����Ϊ��");
						return;
					}else if(sogouTrim(emailValue) == "����������ʼ�"){
							alert("����û����д�����ʼ���");
							return;
		...
		if(false){
			var addValue = document.getElementsByName("sogouVisitorAddress")[0].value;
					if(sogouTrim(addValue) == ""){
						alert("��ϵ�˲���Ϊ��");
						return;
					}else if(sogouTrim(addValue) == "������ϵ�ˣ���xx����/Ůʿ"){
							alert("����û����д����ϵ�ˣ�");
							return;
		...
		document.getElementsByName("sogouVisitorPhone")[0].value = "�������ֻ�����";
		document.getElementsByName("sogouVisitorEmail")[0].value = "����������ʼ�";
		document.getElementsByName("sogouVisitorAddress")[0].value = "������ϵ�ˣ���xx����/Ůʿ";
}
